...
const FEE_PROFILE_HELP = [
  "Path to a fee profile generated by gltest --fee-profile.",
  "Deploy uses the profile deploy entry; write and targeted estimate-fees use the matching method entry.",
  "--fees can still be provided to override profile values.",
].join("\n");
