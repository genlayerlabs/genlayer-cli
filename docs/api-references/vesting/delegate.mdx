---
title: vesting delegate
---

Delegate vesting-held tokens to a validator

### Usage

`$ genlayer vesting delegate [options] [validator]`
...
|  | --amount &lt;amount&gt; | Amount to delegate (in wei or with 'eth'/'gen' suffix) | No |  |
