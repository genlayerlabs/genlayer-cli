...
Claim vesting delegation withdrawals after unbonding period

### Usage

`$ genlayer vesting claim [options] [validator]`
...
| --- | --- | --- | :---: | --- |
|  | --validator &lt;address&gt; | Validator address to claim from (deprecated, use positional arg) | No |  |
