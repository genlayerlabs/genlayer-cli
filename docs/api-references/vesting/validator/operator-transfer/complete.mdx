---
title: vesting validator operator-transfer complete
---

Complete a vesting validator operator transfer

### Usage

`$ genlayer vesting validator operator-transfer complete [options] [wallet]`
