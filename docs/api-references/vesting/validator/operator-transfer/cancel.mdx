---
title: vesting validator operator-transfer cancel
---

Cancel a vesting validator operator transfer

### Usage

`$ genlayer vesting validator operator-transfer cancel [options] [wallet]`
